...
<div id="verticalPage">
  ...
  <div class="title_row">
    ...
    ?>      
            <h1><?php 
               if ($topPundit['Category']['id'] == 3 || $topPundit['Category']['parent_id'] == 3) {
  ...
  <div class="table_holder" id="CallTable">
   <?php } ?>
    ...
    <?php echo $this->element('Vertical/live_call_table', array('liveCallData' => $liveCallData));
     echo $this->Html->link(
            '<span id="allPunditsLink">See All Live Predictions</span>',
            array(
              'controller' => 'categories',
              'action' => 'view_all_calls',$allCategoriesData[0]['Category']['slug'],
              'admin' => false
            ),
            array(
    ...
    <?php echo $this->element('Vertical/archive_call_table', array('liveCallData' => $liveCallData)); ?>
