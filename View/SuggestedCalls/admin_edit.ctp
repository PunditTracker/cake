<div class="suggestedCall form" id="cboxContent1">
  <?php echo $this->Form->create('SuggestedCall', array('class' => 'edit_form', 'id' => 'CallAdminEditForm'));?>
    <h2>
      <?php 
   ...
   /* if (!isset($currentPunditId)) {
    ...
    <div class="pull-left required">
      ...
      <span id= "callYield">
        <?php
        $yield = isset($this->request->data['SuggestedCall']['yield']) ? $this->request->data['SuggestedCall']['yield'] : 0;
         echo "$".$yield;
        ?>
      </span>
    </div>    
    ...
    $ptvariableValue = isset($this->request->data['SuggestedCall']['ptvariable']) ? $this->request->data['SuggestedCall']['ptvariable'] : '1.0';
    echo $this->Form->input(
      'ptvariable',
      array(       
        'type' => 'text',
    ...
    $createdDate = isset($this->request->data['SuggestedCall']['created'])?$this->request->data['SuggestedCall']['created']:'';
    echo $this->Form->input(
      'created',
      array(
        'type' => 'text',
    ...
    $dueDate = isset($this->request->data['SuggestedCall']['due_date'])?$this->request->data['SuggestedCall']['due_date']:'';
    ...
    $voteEndDate = isset($this->request->data['SuggestedCall']['vote_end_date'])?$this->request->data['SuggestedCall']['vote_end_date']:'';
    ...
    <div class="actions edit_btns">
      ...
      echo $this->Form->submit(
       ...
       $this->Form->unlockField('SuggestedCall.id');
       $this->Form->unlockField('SuggestedCall.action');
